/**
 * 作者：BaoMax
 * 链接：https://www.jianshu.com/p/936077e7727a
 * 來源：简书
...
var ChineseCalendar = {
    ...
    festiveList:{
        0:{title:"母亲节",content:""},
        1:{title:"父亲节",content:""},
        2:{title:"感恩节",content:"知恩于心，感恩于行。"},
        3:{title:"元旦",content:"元谓首；旦谓日，新年新征途，愿你与更好的自己相遇！"},
        4:{title:"情人节",content:"愿世界化为沧海，愿你我归于初见。"},
        5:{title:"妇女节",content:"“三八”国际妇女节是全世界女性共同的节日，是各国妇女争取和平、平等、发展的节日"},
        6:{title:"植树节",content:"多一片绿叶，多一份温馨"},
        7:{title:"愚人节",content:"今天你被人整了没"},
        8:{title:"劳动节",content:"愿你所有的辛劳都有回报。"},
        9:{title:"青年节",content:"—— 奋勇当先，不负青春！ ——"},
        11:{title:"儿童节",content:"儿童急走追黄蝶，飞入菜花无处寻"},
        //12:{title:"建军节",content:""},
        13:{title:"教师节",content:"老师好！老师再见！"},
        14:{title:"国庆节",content:"沉浸在为祖国母亲庆生，不能自拔"},
        15:{title:"平安夜",content:"平安夜，夜平安"},
        16:{title:"圣诞节",content:"什么是圣诞快乐？不是那快乐的时光，不是那鸟儿的歌唱，而是那愉快的念头和幸福的笑容！"},
        17:{title:"春节",content:"爆竹声中一岁除，春风送暖入屠苏。<br/>千门万户曈曈日，总把新桃换旧符。"},
        18:{title:"元宵节",content:"花灯万盏亮如昼，相约赏灯黄昏后。"},
        19:{title:"端午节",content:"风雨端阳生晦冥，汨罗无处吊英灵。<br/>海榴花发应相笑，无酒渊明亦独醒。"},
        20:{title:"七夕节",content:"银烛秋光冷画屏，轻罗小扇扑流萤。<br/>天阶夜色凉如水，卧看牵牛织女星。"},
        21:{title:"中元节",content:"如果今天有人说你外貌美丽，声音美丽，眼睛美丽，笑容美丽，身材美丽。你都要一笑而过。那是因为今天是鬼节，他们在鬼话连篇。"},
        22:{title:"中秋节",content:"最圆的月亮永远在家的方向。"},
        23:{title:"重阳节",content:"你们陪我长大，我陪你们变老。"},
        24:{title:"腊八节",content:"腊八腊八，冻死寒鸦"},
        25:{title:"小年",content:"又称祭灶节，灶君要回天庭向玉皇大帝述职，禀告人间善恶是非。"},
        26:{title:"除夕",content:"故岁今宵尽，新年明日来。"},
        27:{title:"清明节",content:"清明时节雨纷纷，路上行人欲断魂。<br/>借问酒家何处有？牧童遥指杏花村。"},
        28:{title:"冬至",content:"古时漂在外地的人到了这时节都要回家过冬节，所谓“年终有所归宿”。"},
        29:{title:"万圣节",content:"即使经历了命运的恶作剧，也总能等到甜蜜的糖果。"},
        30:{title:"龙抬头",content:"“二月二龙抬头”——龙欲升天的日子,象征着春回大地、万物复苏。"},
        31:{title:"寒食节",content:"子推言避世，山火遂焚身"},
        32:{title:"寒衣节",content:"寒衣节流行于北方，有的人会在这一天祭扫，纪念仙逝亲人，谓之送寒衣。"},
        99:{title:"我的生日(农历七月十八)",content:"真是有意义的一天啊"}
    },
    /**
     * 参数为农历日期
     * @method 根据年份计算有多少天
    ...
    isFestive: function(y, m, d, ly, lm, ld) {
        ...
        //清明,冬至
        switch(ChineseCalendar.isTerm(y,m,d)){
            case "清明":arr.push( 27 );break;
            case "冬至":arr.push( 28 );break;
        }

        //算阳历
        festive = ChineseCalendar.cFestive;
        for (var i = 0, l = festive.length; i < l; i += 1) {
            if(!festive[i]){continue;}
        ...
        switch(ChineseCalendar.isTerm(y,m,d+1)){
            //清明前一天是寒食节
            case "清明":arr.push( 31 );
        }
